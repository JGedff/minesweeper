...
export const BoardModule = ({
    dimensions, oldBoard, visibleBoard, updateVisibleBoard, cascade, looseGame, substractAFlag,
    addAFlag, flagsRemaining, disableStatus, finishedGame, DEBUGshowGuide, startGame
    }) => {
